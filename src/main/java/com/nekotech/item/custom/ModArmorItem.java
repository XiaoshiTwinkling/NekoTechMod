...
import com.nekotech.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, List<StatusEffectInstance>> MAP =
            (new ImmutableMap.Builder<ArmorMaterial, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.NEKO_COPPER.value(),
                            Arrays.asList(new StatusEffectInstance(StatusEffects.SPEED, 1000, 1, false,false,true)))
                    .build();

    public ModArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings, String tooltipTranslationKey) {
